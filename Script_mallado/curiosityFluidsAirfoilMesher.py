...
DomainHeight=60  # Multiples Chord Length
WakeLength=60 	 # Multiples Chord Length
firstLayerHeight=0.000008   # Multiples Chord Length
growthRate=1.05				
MaxCellSize=1	# Multiples of chordlength
WakeAngle=5


#These Values can be played with to improve mesh quality
BLHeight=0.3  #Fraction of chord length - Height of BL block
LeadingEdgeGrading=2.5
...
thetawake=math.atan(nxT - WakeAngle*0.01/nyT)
